					...
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--40 p-b-40">
							...
							<div class="flex-wr-sb-s p-t-40 p-b-15 how-bor2">
								<a href="index.php?page=detail_berita&id=<?=$row['id'];?>" class="size-w-8 wrap-pic-w hov1 trans-03 w-full-sr575 m-b-25">
									<img src="pages/Berita/img/<?= $row['gambar']; ?>" alt="IMG" height="200">
								</a>

								<div class="size-w-9 w-full-sr575 m-b-25">
									<h5 class="p-b-12">
										<a href="index.php?page=detail_berita&id=<?=$row['id'];?>" class="f1-l-1 cl2 hov-cl10 trans-03 respon2">
											<?= $row['judul']; ?> 
										</a>
									</h5>
									...
									<a href="index.php?page=detail_berita&id=<?=$row['id'];?>" class="f1-s-1 cl9 hov-cl10 trans-03">
										Read More
