      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="pages/Berita/ubah_proses.php" enctype='multipart/form-data'>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="pages/Berita/img/<?php echo $row['gambar'] ?>" width="500" height="350"></br><br>
